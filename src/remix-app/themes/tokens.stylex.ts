...
export const tokens = stylex.defineVars<Tokens>({
  ...
  color_gradient_three_background_start: stylex.types.color({ default: blueGrey.bg100, [DARK]: blueGrey.bg700 }),
  color_gradient_three_background_end: stylex.types.color({ default: blueGrey.bg200, [DARK]: blueGrey.bg800 }),
  /* ---------------------------- */
  // Actions
